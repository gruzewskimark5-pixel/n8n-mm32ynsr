...
To prevent broken workflows from wasting resources, n8n is configured to automatically deactivate any workflow that fails 2 times in a row (`N8N_WORKFLOW_AUTODEACTIVATION_ENABLED: "true"`).
