...
3. **Save:** Click **Save Changes.** Render will automatically restart your service with the new settings. Note that very long executions may lead to service instability on the Free Tier.
