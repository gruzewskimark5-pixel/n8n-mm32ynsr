...
- ⚡ **Free Tier Optimized:** Pre-tuned for Render's free tier:
  ...
  - **Lean Background:** Optimized for stability and speed by disabling non-essential features and background tasks:
    - **Disabled Features:**
      - 🧩 **Templates:** [Templates](#missing-templates-tab)
      - 🔌 **Community Nodes:** [Community nodes](#missing-community-nodes)
      - 🖼️ **External Icons:** [External icons](#missing-node-icons)
      - 👤 **Personalization:** Personalization flow
      - 👋 **Onboarding:** Onboarding flow
      - 📡 **Telemetry:** Diagnostics and telemetry
      - 📊 **Metrics:** Internal metrics
      - 🏁 **Hiring Banners:** Console hiring banners
...
1. **Find your URL:** Find your unique service URL at the top of the service page or under the **Connect** button in the [Render Dashboard](https://dashboard.render.com/) (e.g., `https://n8n-service-q975.onrender.com`). Copy this URL, as you will need it for [Step 2](#2-configure-webhook-url-required).
...
If you're troubleshooting an issue, navigate to your service's **Logs** tab in the [Render Dashboard](https://dashboard.render.com/).
