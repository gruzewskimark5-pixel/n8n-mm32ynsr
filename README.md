...
2. **Visit your URL:** Click the link to open your n8n instance in a new tab.
3. **Create account:** Follow the on-screen instructions to set up your first owner account.
4. **✅ Verify:** Once the account is created, you will be automatically logged in and see the n8n workflow canvas.
