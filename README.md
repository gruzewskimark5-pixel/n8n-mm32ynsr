...
Your credentials in n8n are encrypted with a unique key. This key was automatically generated by Render during your first deployment. If you ever need to migrate or restore your n8n instance, you will need this key. **If you lose this key, you will permanently lose access to all your stored credentials in n8n.**
...
- 🆕 **Release Notes:** Check the [n8n release notes](https://github.com/n8n-io/n8n/releases) for new features and breaking changes before updating.
...
> [!WARNING]
> Render's **Free Tier PostgreSQL** does not include automated backups. We recommend performing manual exports regularly to prevent data loss.
...
- 🎬 **Video Tutorials:** Check out the [n8n YouTube channel](https://www.youtube.com/@n8n-io) for visual guides.
