...
To adjust how many failures are allowed before deactivation, you can update the `N8N_WORKFLOW_AUTODEACTIVATION_MAX_LAST_EXECUTIONS` environment variable in the [Render Dashboard](https://dashboard.render.com/).
