...
- ⚡ **Free Tier Optimized:** Pre-tuned for Render's free tier:
  ...
  - **Lean Background:** Optimized for stability and speed by disabling non-essential features and background tasks:
    - **Disabled Features:** Templates, task runners, community nodes, personalization, onboarding, telemetry, and hiring banners.
  ...
  - **Auto-maintenance:** Automated execution and history pruning (7 days / 10 versions) to keep the database lean.
...
> [!TIP]
> 💤 If your service has spun down due to inactivity, it may take 1-2 minutes to start up. If you see a `503 Service Unavailable` message, wait a minute and refresh the page.
...
```text
https://your-service-name.onrender.com/healthz/readiness
```
